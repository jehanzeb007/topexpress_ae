...
@else
    ...
    <section class="bg-dark">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 @if($layout == 'full' || $layout == 'grid_full') d-block d-md-none @endif" >
...
<div id="traffic-popup-map-template" style="display: none" type="text/x-custom-template">

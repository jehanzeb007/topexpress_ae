...
<div id="main-wrapper">
    ...
    <div class="topbar bg-brand p-2">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">

                <!-- LEFT SIDE -->
                <div class="d-flex align-items-center">
                    <a href="https://wa.me/{{ theme_option('whatsapp') }}" target="_blank" class="text-white me-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#00a82d" viewBox="0 0 16 16">
                        ...
                        {{ theme_option('whatsapp') }}
                    </a>
                    <a href="tel:{{ theme_option('hotline') }}" class="text-white">
                        <i class="fa fa-phone"></i> {{ theme_option('hotline') }}
                    </a>

                    @if (is_plugin_active('language'))
                        <div class="ms-3 currency-wrapper">
                ...
                @if (is_plugin_active('real-estate'))
                    <div class="topbar-right d-flex align-items-center">
                        ...
                        <div class="topbar-wishlist me-3">
                            <a class="text-white" href="{{ route('public.wishlist') }}">
                        ...
                        @if (count($currencies) > 1)
                            <div class="text-white currency-wrapper">
                                <div class="dropdown">
                                    <a class="btn dropdown-toggle text-white" href="#" data-bs-toggle="dropdown">
                                        {{ get_application_currency()->title }}
                                    </a>
                                    <ul class="dropdown-menu">
                                        @foreach ($currencies as $currency)
                                            <li>
                                                <a class="dropdown-item {{ get_application_currency_id() == $currency->id ? 'active' : '' }}"
                ...
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    @if (is_plugin_active('real-estate') && RealEstateHelper::isRegisterEnabled())
                        <ul class="nav-menu nav-menu-social align-to-right">
                            <li>
                                <a href="https://wa.me/{{ theme_option('whatsapp') }}" target="_blank" class="p-2">
                                    <i>
